...
if __name__ == '__main__':
    ...
    agent = DQNAgent(args.device, args.memory_device, args.memory_len, args.batch_size, args.n_layer, args.n_embd, args.n_head, args.wait_quantization, args.dropout)
